...
const places = [
  ...
  "Playa Prieta, Casco Viejo, Panama",
  "Plaza Bolivar, San Felipe, Panama",
  ...
  "La Fisheria, Panama",
  "Mercado San Felipe Neri, Panama",
...
async function run() {
  for (const place of places) {
    ...
    if (res.lat) {
      // bbox=-79.5385, 8.9495, -79.5285, 8.9565
